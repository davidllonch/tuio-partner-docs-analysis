...
from app.routers import validate_documents as validate_documents_router
...
app.include_router(contract_templates_router.router, prefix="/api")
app.include_router(validate_documents_router.router, prefix="/api")
